    ...
    <>
      ...
      <Section width="100%" height="800px" marginTop="10vh" responsiveHeight7="700px">
        <Container margin='auto' width="80%" height="100%">
            <Card width='500px' height='100%' margin='auto' resWidth4='300px' resHeight4='70%' resWidth7='350px' resHeight7='80%' resWidth5='300px' resHeight5='80%'>
              {isReady ? <Image resWidth4="250px" resHeight4="250px" margin="10px auto" borderRadius="8px" width='300px' height="300px"  resWidth7='250px' resHeight7='250px' resWidth5='200px' resHeight5='200px' src={`${dataJson[id-1].ImgUTL}`} alt="detailedImage"/> : null}
